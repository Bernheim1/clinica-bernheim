...
@Component({
  selector: 'app-cancelar-turno-administrador',
  templateUrl: './cancelar-turno-administrador.component.html',
  styleUrls: ['./cancelar-turno-administrador.component.scss']
})
export class CancelarTurnoAdministradorComponent implements OnInit {
